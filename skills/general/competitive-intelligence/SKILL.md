...
0. **Conflar conceptos relacionados** — "Skill bundles" y "agent skills" son cosas distintas. Primero buscar precision, no asumir que el usuario habla del concepto mas amplio. Si pregunta por X especifico, responder sobre X, no sobre Y aunque parezca relacionado. El usuario valora precision.
